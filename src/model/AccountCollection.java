 ...
 * of Accounts for the MemoryGame application.
 * 
...
public class AccountCollection implements java.io.Serializable {
	...
	/**
	 * The constructor for AccountCollection, initializes
	 * the arrayList.
	 */
	...
	/**
	 * This method is the getter for account at index index
	 * of the AccountCollection.
	 * 
	 ...
	 * for the AcccountCollection class.
	 * 
	...
	/**
	 * This method returns the account of specified username
	 * and password in the AccountCollection, and null if unfound.
	 ...
	 * account with specified username.
	 * 
	 * @param name The username being searched for in the AccountCollection.
	 * @return True if the AccountCollection contains this username, false otherwise.
	 */
	...
	/**
	 * This method returns whether or not the AccountCollection
	 * contains an equivalent account.
	 * 
	 * @param otherAcct The account being searched for.
	 * @return True if the AccountCollection contains an equivalent account, false otherwise.
	 */
